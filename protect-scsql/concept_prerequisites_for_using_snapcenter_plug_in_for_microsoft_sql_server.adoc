...
+
Per informazioni sull'esecuzione del cmdlet, consultare https://library.netapp.com/ecm/ecm_download_file/ECMLP2880726["Guida di riferimento al cmdlet del software SnapCenter"]
...
* Spostare i database esistenti sullo storage NetApp.
+
Per ulteriori informazioni, vedere importazione di informazioni SnapCenter.

+
link:concept_import_archived_backups_from_snapmanager_for_sql_to_snapcenter.html["Importare i backup archiviati da SnapManager per Microsoft SQL Server a SnapCenter"]
