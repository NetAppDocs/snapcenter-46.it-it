...
Per informazioni sulla risoluzione dei problemi, vedere https://kb.netapp.com/mgmt/SnapCenter/SnapCenter_MFA_login_error_The_SAML_message_response_1_doesnt_match_the_expected_response_2["L'accesso a SnapCenter in più schede mostra un errore MFA"]
