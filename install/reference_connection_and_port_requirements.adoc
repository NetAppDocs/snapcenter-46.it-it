...
|===
Per modificare i dettagli della porta, vedere https://docs.netapp.com/us-en/snapcenter/admin/concept_manage_hosts.html#modify-plug-in-hosts[] [Modifica host plug-in^].
