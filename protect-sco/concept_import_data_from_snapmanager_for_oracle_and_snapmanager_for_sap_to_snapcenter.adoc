...
Le configurazioni supportate con il plug-in SnapCenter per database Oracle sono elencate nella https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"^].
