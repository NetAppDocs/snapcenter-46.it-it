...
È possibile attivare o disattivare questo parametro modificando il file *spl.properties* oppure utilizzando l'interfaccia grafica o il cmdlet di SnapCenter.
